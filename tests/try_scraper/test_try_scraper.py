...
firefox_tests = [
    ...
    {'args': {'platform': 'mac64',
     ...
     'target': '8fcac92cfcad-firefox-38.0a1.en-US.mac.dmg',
    ...
    {'args': {'platform': 'linux64',
              'changeset': '8fcac92cfcad'},
     'target': '8fcac92cfcad-firefox-38.0a1.en-US.linux-x86_64.tar.bz2',
     'target_url': 'firefox/try-builds/test-user@mozilla.com-8fcac92cfcad/'
    ...
    {'args': {'platform': 'linux',
              'changeset': '8fcac92cfcad',
              'debug_build': True},
     'target': '8fcac92cfcad-debug-firefox-38.0a1.en-US.linux-i686.tar.bz2',
     'target_url': 'firefox/try-builds/test-user@mozilla.com-8fcac92cfcad/'
                   'try-linux-debug/firefox-38.0a1.en-US.linux-i686.tar.bz2'},
    # -a firefox -p win32 --changeset=8fcac92cfcad
    {'args': {'platform': 'win32',
              'changeset': '8fcac92cfcad'},
     'target': '8fcac92cfcad-firefox-38.0a1.en-US.win32.installer.exe',
     'target_url': 'firefox/try-builds/test-user@mozilla.com-8fcac92cfcad/'
