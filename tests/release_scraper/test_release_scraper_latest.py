...
@pytest.mark.parametrize("args,filename,url", [
    ...
    ({'application': 'firefox', 'platform': 'linux', 'version': 'latest'},
     'firefox-23.1.0.en-US.linux.tar.bz2',
     'firefox/releases/23.1.0/linux-i686/en-US/firefox-23.1.0.tar.bz2'),
    ({'application': 'firefox', 'platform': 'linux64', 'version': 'latest'},
     'firefox-23.1.0.en-US.linux64.tar.bz2',
     'firefox/releases/23.1.0/linux-x86_64/en-US/firefox-23.1.0.tar.bz2'),
    ({'application': 'firefox', 'platform': 'mac', 'version': 'latest'},
     'firefox-23.1.0.en-US.mac.dmg',
     'firefox/releases/23.1.0/mac/en-US/Firefox 23.1.0.dmg'),
    ...
    ({'application': 'firefox', 'platform': 'win64', 'version': 'latest'},
     'firefox-23.1.0.en-US.win64.exe',
     'firefox/releases/23.1.0/win64/en-US/Firefox Setup 23.1.0.exe'),
