...
@pytest.mark.parametrize("args,filename,url", [
    ({'application': 'firefox', 'platform': 'linux', 'version': 'latest'},
     'firefox-23.1.0-build3.en-US.linux.tar.bz2',
     'firefox/candidates/23.1.0-candidates/build3/linux-i686/en-US/firefox-23.1.0.tar.bz2'),
    ({'application': 'firefox', 'platform': 'linux64', 'version': 'latest'},
     'firefox-23.1.0-build3.en-US.linux64.tar.bz2',
     'firefox/candidates/23.1.0-candidates/build3/linux-x86_64/en-US/firefox-23.1.0.tar.bz2'),
    ({'application': 'firefox', 'platform': 'mac', 'version': 'latest'},
     'firefox-23.1.0-build3.en-US.mac.dmg',
     'firefox/candidates/23.1.0-candidates/build3/mac/en-US/Firefox 23.1.0.dmg'),
    ({'application': 'firefox', 'platform': 'win32', 'version': 'latest'},
     'firefox-23.1.0-build3.en-US.win32.exe',
     'firefox/candidates/23.1.0-candidates/build3/win32/en-US/Firefox Setup 23.1.0.exe'),
    ({'application': 'firefox', 'platform': 'win64', 'version': 'latest'},
     'firefox-23.1.0-build3.en-US.win64.exe',
     'firefox/candidates/23.1.0-candidates/build3/win64/en-US/Firefox Setup 23.1.0.exe'),
