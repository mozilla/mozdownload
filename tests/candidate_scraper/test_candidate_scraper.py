...
firefox_tests = [
    ...
    # -a firefox -t candidate -p linux -v 21.0
    {'args': {'application': 'firefox',
              'platform': 'linux',
              'version': '21.0'},
     'target': 'firefox-21.0-build3.en-US.linux.tar.bz2'},
    # -a firefox -t candidate -p linux64 -v 21.0
    {'args': {'application': 'firefox',
              'platform': 'linux64',
              'version': '21.0'},
     'target': 'firefox-21.0-build3.en-US.linux64.tar.bz2'},
    # -a firefox -t candidate -p mac -v 21.0
    {'args': {'application': 'firefox',
              'platform': 'mac',
              'version': '21.0'},
     'target': 'firefox-21.0-build3.en-US.mac.dmg'},
    # -a firefox -t candidate -p win32 -v 21.0
    {'args': {'application': 'firefox',
              'platform': 'win32',
              'version': '21.0'},
     'target': 'firefox-21.0-build3.en-US.win32.exe'},
    # -a firefox -t candidate -p win32 -v 21.0 -l cs
    {'args': {'application': 'firefox',
              'locale': 'cs',
              'platform': 'win32',
              'version': '21.0'},
     'target': 'firefox-21.0-build3.cs.win32.exe'},
    # -a firefox -t candidate -p win32 -v 21.0 -l en-GB
    {'args': {'application': 'firefox',
              'locale': 'en-GB',
              'platform': 'win32',
              'version': '21.0'},
     'target': 'firefox-21.0-build3.en-GB.win32.exe'},
    # -a firefox -t candidate -p win32 -v 21.0 --build-number=1
    {'args': {'application': 'firefox',
              'build_number': '1',
              'platform': 'win32',
              'version': '21.0'},
     'target': 'firefox-21.0-build1.en-US.win32.exe'},
    # -a firefox -t candidate -p win32 -v 21.0 --stub
    {'args': {'application': 'firefox',
...
class ReleaseScraperTest(mhttpd.MozHttpdBaseTest):
    ...
    def test_scraper(self):
        ...
        for entry in tests:
            scraper = ReleaseCandidateScraper(directory=self.temp_dir, base_url=self.wdir,
                                     **entry['args'])
