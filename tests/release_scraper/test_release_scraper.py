...
class ReleaseScraperTest(mhttpd.MozHttpdBaseTest):
    ...
    def test_scraper(self):
        ...
        ffox_release_dir = urljoin(self.wdir, 'firefox', 'releases')
        ...
        firefox_tests = [
            ...
            {'args': {'platform': 'win32',
             ...
             'target_url': urljoin(ffox_release_dir, 'latest', 'win32', 'en-US',
                                   'Firefox Setup 23.0.1.exe')},
            ...
            {'args': {'application': 'firefox',
             ...
             'target_url': urljoin(ffox_release_dir, 'latest', 'linux-i686', 'en-US',
                                   'firefox-23.en-US.linux.tar.bz2')},
            # -a firefox -p linux64 -v latest
            {'args': {'application': 'firefox',
                      'platform': 'linux64',
                      'version': 'latest'},
             'target': 'firefox-latest.en-US.linux64.tar.bz2',
             'target_url': urljoin(ffox_release_dir, 'latest', 'linux-x86_64', 'en-US',
                                   'firefox-23.en-US.linux.tar.bz2')},
            ...
            {'args': {'application': 'firefox',
             ...
             'target_url': urljoin(ffox_release_dir, 'latest', 'mac', 'en-US',
                                   'firefox-23.dmg')},
            ...
            {'args': {'application': 'firefox',
             ...
             'target_url': urljoin(ffox_release_dir, 'latest', 'win32', 'de',
                                   'Firefox Setup 23.0.1.exe')},
            ...
            {'args': {'application': 'firefox',
             ...
             'target': 'firefox-latest.en-US.win32.exe',
             'target_url': urljoin(ffox_release_dir, 'latest', 'win32', 'en-US',
                                   'Firefox Setup Stub 23.0.1.exe')},
            # -a firefox -p win32 -v 21.0
            {'args': {'application': 'firefox',
                      'platform': 'win32',
                      'version': '21.0'},
             'target': 'firefox-21.0.en-US.win32.exe',
             'target_url': urljoin(ffox_release_dir, '21.0', 'win32', 'en-US',
            ...
            {'args': {'application': 'firefox',
             ...
             'target_url': urljoin(ffox_release_dir, '21.0', 'win32', 'es-ES',
                                   'Firefox Setup 21.0.exe')}
        ]

        tbird_release_dir = urljoin(self.wdir, 'thunderbird', 'releases')
        ...
        thunderbird_tests = [
            ...
            {'args': {'application': 'thunderbird',
             ...
             'target_url': urljoin(tbird_release_dir, 'latest', 'win32',
                                   'en-US', 'Thunderbird Setup 17.0.1.exe')},
            # -a thunderbird -p linux -v latest
            {'args': {'application': 'thunderbird',
                      'platform': 'linux',
                      'version': 'latest'},
             'target': 'thunderbird-latest.en-US.linux.tar.bz2',
             'target_url': urljoin(tbird_release_dir, 'latest', 'linux-i686',
                                   'en-US',
            ...
            {'args': {'application': 'thunderbird',
             ...
             'target_url': urljoin(tbird_release_dir, 'latest', 'linux-x86_64',
                                   'en-US',
                                   'thunderbird-17.0.en-US.linux.tar.bz2')},
            ...
            {'args': {'application': 'thunderbird',
             ...
             'target_url': urljoin(tbird_release_dir, 'latest', 'mac',
                                   'en-US', 'thunderbird-17.0.dmg')},
            ...
            {'args': {'application': 'thunderbird',
             ...
             'target_url': urljoin(tbird_release_dir, 'latest', 'win32',
                                   'de', 'Thunderbird Setup 17.0.1.exe')},
            # -a thunderbird -p win32 -v 16.0
            {'args': {'application': 'thunderbird',
                      'platform': 'win32',
                      'version': '16.0'},
             'target': 'thunderbird-16.0.en-US.win32.exe',
             'target_url': urljoin(tbird_release_dir, '16.0', 'win32',
                                   'en-US', 'Thunderbird Setup 16.0.exe')},
            ...
            {'args': {'application': 'thunderbird',
             ...
             'target_url': urljoin(tbird_release_dir, '16.0', 'win32',
                                   'es-ES', 'Thunderbird Setup 16.0.exe')}
        ]

        self.tests = firefox_tests + thunderbird_tests
